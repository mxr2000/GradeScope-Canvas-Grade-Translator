...
### file%3A%2F%2F%2FUsers%2Fmxr%2FDocuments%2Fsrc%2Fscala%2FGradeTranslator%2FGradeTranslator%2Fsrc%2Fmain%2Fscala%2FGradeScope.scala:23: error: ; expected but : found
):
 ^
    ...
    def parseTableRow(trElement: Element): Option[GradeScopeSubmission] = {
      trElement.select("td").asScala.toList match
        case firstTdElement :: _ :: thirdTdElement :: fourthTdElement :: _ =>
          ...
          time.map(t =>
            GradeScopeSubmission(firstTdContent, fourthTdContent, t)
          )
        case _ => None
    }
